...
class DCGAN(object):
    def __init__(self, sess, input_height=108, input_width=108, is_crop=True, batch_size=64, sample_num=64,
                 ...
                 dfc_dim=1024, c_dim=3, dataset_name='default', input_fname_pattern='*.jpg',
        ...
        Args:
            ...
            df_dim: (optional) Dimension of discriminate filters in first conv layer. [64]
            gfc_dim: (optional) Dimension of gen units for for fully connected layer. [1024]
            dfc_dim: (optional) Dimension of discriminate units for fully connected layer. [1024]
            c_dim: (optional) Dimension of image color. For gray scale input, set to 1. [3]
        """
        self.sess = sess
    ...
    def train(self, config):
        ...
        if config.dataset == 'mnist':
            ...
            data_X, data_y = load_data(n=self.input_height)
        else:
    ...
    def sampler(self, z, y=None):
        with tf.variable_scope("generator") as scope:
            ...
            if not self.y_dim:
                ...
                # project `z` and reshape
                h0 = tf.reshape(
                linear(z, self.gf_dim*8*s_h16*s_w16, 'g_h0_lin'), [-1, s_h16, s_w16, self.gf_dim * 8])
